...
def test_no_transform_default():
    ...
    assert mapping.last_time == 0.0
    assert mapping.time_condition_fulfilled(0.01) == True
    assert mapping.last_time == 0.01
    assert mapping.time_condition_fulfilled(0.02) == False
    assert mapping.last_time == 0.01
    assert mapping.time_condition_fulfilled(1.00) == False
    assert mapping.last_time == 0.01
    assert mapping.time_condition_fulfilled(1.02) == True
    assert mapping.last_time == 1.02
    assert mapping.time_condition_fulfilled(1.50) == False
    assert mapping.last_time == 1.02
    assert mapping.time_condition_fulfilled(2.03) == True
    assert mapping.last_time == 2.03
    
    # Change shall always report true regardless of value
    assert mapping.last_vss_value is None
    assert mapping.change_condition_fulfilled(23) == True
    assert mapping.last_vss_value == 23
    assert mapping.change_condition_fulfilled(23) == True
    assert mapping.change_condition_fulfilled(24) == True
...
def test_no_transform_interval_500():
    ...
    assert mapping.time_condition_fulfilled(0.01) == True
    assert mapping.time_condition_fulfilled(0.02) == False
    assert mapping.time_condition_fulfilled(0.50) == False
    assert mapping.time_condition_fulfilled(0.52) == True
    assert mapping.time_condition_fulfilled(1.00) == False
    assert mapping.time_condition_fulfilled(1.03) == True
...
def test_no_transform_on_change_true():
    ...
    # First plus always
    assert mapping.time_condition_fulfilled(0.01) == True
    assert mapping.time_condition_fulfilled(45.0) == True
    assert mapping.time_condition_fulfilled(45.0) == True
    assert mapping.time_condition_fulfilled(48.0) == True
    assert mapping.time_condition_fulfilled(49.0) == True
    
    # First plus on change
    assert mapping.change_condition_fulfilled(23) == True
    assert mapping.change_condition_fulfilled(23) == False
    assert mapping.change_condition_fulfilled(46) == True
    assert mapping.change_condition_fulfilled(46) == False
...
def test_no_transform_always():
    ...
    # First shall always be sent
    assert mapping.time_condition_fulfilled(0.01) == True
    assert mapping.time_condition_fulfilled(0.02) == True
    assert mapping.time_condition_fulfilled(0.50) == True
    assert mapping.time_condition_fulfilled(0.52) == True
    assert mapping.time_condition_fulfilled(1.00) == True
    assert mapping.time_condition_fulfilled(1.03) == True
